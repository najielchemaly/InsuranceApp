...
extension UIButton {
    ...
    func setSelected(value: Bool) {
        if value {
            self.backgroundColor = Colors.textDarkBlue
            self.setTitleColor(Colors.textLightGray, for: .normal)
        } else {
            self.backgroundColor = Colors.textLightGray
            self.setTitleColor(Colors.textDarkBlue, for: .normal)
        }
    }
    
    func isSelected() -> Bool {
        if self.backgroundColor == Colors.darkBlue {
            return true
        } else {
            return false
        }
