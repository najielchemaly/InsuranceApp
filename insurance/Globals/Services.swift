...
//  insurance
//
//  Created by MR.CHEMALY on 9/12/18.
...
class Services {
    ...
    static let ConfigUrl = "http://config.innocentminds.com/"
    //    private let ConfigUrl = "http://localhost/innocentminds/services/getConfig/"
